...
ALTER TABLE PaymentRequest DROP FOREIGN KEY FKPaymentReq551000;
ALTER TABLE PaymentRequest DROP FOREIGN KEY FKPaymentReq235996;
...
CREATE TABLE Book (ID int(11) NOT NULL AUTO_INCREMENT, Title varchar(255), Language varchar(255), Summary mediumtext, Table_of_contents mediumtext, Image varchar(255), Pdf varchar(255), Doc varchar(255), Fb2 varchar(255), Price float NOT NULL, Status varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Author (ID int(11) NOT NULL AUTO_INCREMENT, Name varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Field (ID int(11) NOT NULL AUTO_INCREMENT, Field varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Membership (ID int(11) NOT NULL AUTO_INCREMENT, Type varchar(255), Price float NOT NULL, Days int(11) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE User_Membership (S_date date, E_date date, Status varchar(255), MembershipID int(11) NOT NULL, GeneralUserID varchar(255) NOT NULL, PRIMARY KEY (MembershipID, GeneralUserID)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Subject (ID int(11) NOT NULL AUTO_INCREMENT, FieldID int(11) NOT NULL, Sub varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Review (ID int(11) NOT NULL AUTO_INCREMENT, Text varchar(255), Status varchar(255), User_BookGeneralUserID varchar(255) NOT NULL, User_BookBookID int(11) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE PaymentRequest (ID int(11) NOT NULL AUTO_INCREMENT, MembershipID int(11), BookID int(11), GeneralUserID varchar(255) NOT NULL, `Date` date, PaymentInfo varchar(255), Status varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Views_Date (`Date` date NOT NULL, BookID int(11) NOT NULL, ViewCount int(11) NOT NULL, PRIMARY KEY (`Date`)) ENGINE=InnoDB CHARACTER SET UTF8;
...
ALTER TABLE PaymentRequest ADD INDEX FKPaymentReq551000 (BookID), ADD CONSTRAINT FKPaymentReq551000 FOREIGN KEY (BookID) REFERENCES Book (ID);
ALTER TABLE PaymentRequest ADD INDEX FKPaymentReq235996 (MembershipID), ADD CONSTRAINT FKPaymentReq235996 FOREIGN KEY (MembershipID) REFERENCES Membership (ID);
