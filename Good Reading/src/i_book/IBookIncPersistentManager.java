...
public class IBookIncPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "IBookInc";
	...
	private IBookIncPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new IBookIncPersistentManager();
		}
