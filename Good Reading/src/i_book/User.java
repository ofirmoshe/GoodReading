...
public class User extends i_book.GeneralUser {
	...
	public final i_book.User_BookSetCollection user_Books = new i_book.User_BookSetCollection(this, _ormAdapter, i_book.ORMConstants.KEY_USER_USER_BOOKS, i_book.ORMConstants.KEY_USER_BOOK_USER, i_book.ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final i_book.User_MembershipSetCollection user_Memberships = new i_book.User_MembershipSetCollection(this, _ormAdapter, i_book.ORMConstants.KEY_USER_USER_MEMBERSHIPS, i_book.ORMConstants.KEY_USER_MEMBERSHIP_USER, i_book.ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final i_book.PaymentRequestSetCollection paymentrequest = new i_book.PaymentRequestSetCollection(this, _ormAdapter, i_book.ORMConstants.KEY_USER_PAYMENTREQUEST, i_book.ORMConstants.KEY_PAYMENTREQUEST_USER, i_book.ORMConstants.KEY_MUL_ONE_TO_MANY);
